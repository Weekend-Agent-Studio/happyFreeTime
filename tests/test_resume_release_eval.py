...
class ResumeReleaseEvaluationTest(unittest.TestCase):
    ...
    def test_advisor_metrics_separate_acceptance_and_grounding(self) -> None:
        ...
        self.assertEqual(metrics["advisor_model_plan_coverage"]["value"], 1.0)
        self.assertEqual(metrics["advisor_id_grounding_rate"]["value"], 1.0)
        self.assertEqual(metrics["advisor_fact_grounding_rate"]["value"], 1.0)
